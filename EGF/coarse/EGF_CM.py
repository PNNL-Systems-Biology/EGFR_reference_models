...
Ligand: ppErk -> L; Reg_T_CM_asp(v1, ro1, k1, k2, Precursor, ppErk, L, KmPre, KmE, KmL, w1, m1, m2);
EGFRp:  L -> Rp; Reg_T_CM_isp(v2, ro2, k3, k4, Mig6, L, Rp, KmMig, KmL, KmP, w2, m3, m4);
Ras:    Rp -> R; Reg_T_CM_iiisp(v3, ro3, ro4, ro5, k5, k6, Spry2, Rp, ppErk, Rp, R, KmSpr, KmPi, KmEi, KmP, KmR, w3, w4, w5, m5, m6)
Erk:    R -> ppErk; T_CM_sp(v4, k7, k8, R, ppErk, KmR, KmE, m7, m8);
