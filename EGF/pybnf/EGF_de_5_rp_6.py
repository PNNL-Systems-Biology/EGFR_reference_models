...
model EGF()
 ...
 // Variable initializations:
  ...
  kh = 0.0004; // 0.00024;
  kh has per_sec; 
  k2 = 990220379.1273011; // updated 3-20
  k2 has per_nMs;
  k_2 = 3.295216611884765e-08; // updated 3-20
  k_2 has per_sec;
  k3 = 659268259.8888985; // 0.067; // This is the phosphorylation probability
  k3 has per_sec;
  k_3 = 0.0008880480627104542; // Dephosphorylation probability
  k3 has per_sec;
  k4 = 0.003456938219388241; // Receptor-GS forward rate constant
  k4 has per_nMs;
  k_4 = 0.00010531616995330067; // Receptor-GS reverse rate constant
  k_4 has per_sec;
  k5 = 0.006327419039413524; // Receptor - Shc recruitment
  k5 has per_nMs;
  k_5 = 2.1650623480924933; // Dissociation of Shc from phospho-EGFR
  k_5 has per_sec;
  k6 = 1763.6783878754788; // Phosphorylation of Shc
  k6 has per_sec;
  k7 = 60.20630445910879; // Receptor-pShc forward rate constant
  k7 has per_nMs;
  k_7 = 0.00093940581315385; // Receptor-pShc reverse rate constant
  k_7 has per_sec;
  V8 = 92.33725707898917; // Dephosphorylation of Shc
  k8 has per_sec;
  V8 has nM_per_s;
  Km8 = 10.362661374851898;
  Km8 has nM;
  k8 = 1.3;	
  k9 = 13.30318480830999; // forward rate Grb2-Sos binding to pShc on receptor
  k9 has per_nMs;
  k_9 = 9.759447790526457e-05; // dissociation of Grb2-Sos from pShc-receptor complex
  k_9 has per_sec;
  k10 = 8.512448987804383e-12; // association pShc-GS to Rp
  k10 has per_nMs;
  k_10 = 87592317.11332706; // reverse binding of Grb2-Sos-pShc from receptor
  k_10 has per_sec;
  k11 = 76002.51742612755; // association of pShc with GS
  k11 has per_nMs;
  k_11 = 8112588171260687.0; // dissociation of pShc-GS complex
  k_11 has per_sec;
  k13 = 3.3691894803368615e-10; // Association of RasGap with EGFR
  k13 has per_nMs;
  k_13 = 0.0014959102863162561; // Dissociation of RasGap
  k_13 has per_sec;
  krec = 545.3019071068909; // Recycling of the GS to pool
  krec has per_sec;
  k204 = 2.0180453954731; //Grb2-SOS association rate constant
  k204 has per_nMs;
  k_204 = 1.5423831345199412e-05;
  k_204 has per_sec;	// Grb2-Sos dissociation rate constant
  k205 = 0.006424311585956219; // Binding of SOS by Erk
  k205 has per_nMs;
  k_205 = 3.512356691796979e-05; // Dissociation of SOS from ppErk
  k_205 has per_sec;
  kcat205 = 0.008211173787709003; // phosphorylation of SOS
  kcat205 has per_sec;
  kcat_205 = 0.0033853164385974884; // dephosphorylation of SOS
  kcat_205 has per_sec;
  k206 = 0.00012102959669188191; // Binding of 14-3-3 protein to Sos
  k206 has per_nMs;
  k_206 = 93771.42129308255; // Dissociation of 14-3-3 protein from Sos
  k_206 has per_sec;
  k60 = 0.0037940233276696363; // Binding of Raf by Erk
  k60 has per_nMs;
  k_60 = 257.3048753227912; // Dissociation of Raf from ERK
  k_60 has per_sec;
  kcat60 = 5.322430799361314; // phosphorylation of Raf by Erk
  kcat60 has per_sec;
  kcat_60 = 2040636.541900056; // dephosphorylation of Raf
  kcat_60 has per_sec;
  k61 = 575.1963055336787; // Binding of 14-3-3 protein to Raf
  k61 has per_nMs;
  k_61 = 1.909579936634132e-05; // Dissociation of 14-3-3 protein from Raf
  k_61 has per_sec;
  kcat62 = 1.579395989641976e-05; // Activation of Ras
  kcat62 has per_sec;
  Km62 = 2267149.1787780686;
  Km62 has nM;
  kcat63 = 1862660.2470099344; // ORIG 20000;
  kcat63 has per_sec;
  Km63 = 138312.80405382003;
  Km63 has nM;
  kcat65 = 0.00025688876899091845;
  kcat65 has per_sec;
  Km65 = 18.96138313033725;
  Km65 has nM;
  kcat66 = 0.7885828896055298; // activation of raf
  kcat66 has nM_per_s;
  Km66 = 1.782408668213566e+17; // raf activation equilibrium constant
  Km66 has nM;
  kcat67 = 52.64953385602939; // inactivation of Raf
  kcat67 has nM_per_s;
  Km67 = 0.13194230038482677; // Equilibrium inactivation of Raf
  Km67 has nM;
  kcat68 = 4.922551583477753e-08;
  kcat68 has per_sec;
  Km68 = 0.08002195195915288;
  Km68 has nM;
  V69 = 75393.0743385259; // inactivation of Mek
  V69 has nM_per_s;
  Km69 = 501.3215392097308;
  Km69 has nM;
  kcat70 = 55826112.15387671;
  kcat70 has per_sec;
  Km70 = 564.3493693845837;
  Km70 has nM;
  kcat71 = 37.014840823672884;
  kcat71 has per_sec;
  Km71 = 0.04981381172820657;
  Km71 has nM;
  V72 = 55639369.98735136;
  V72 has nM_per_s;
  Km72 = 29140.781696656144;
  Km72 has nM;
  V73 = 1.0665029011642388e-05;
  V73 has nM_per_s;
  Km73 = 650.876546606719;
  Km73 has nM;
