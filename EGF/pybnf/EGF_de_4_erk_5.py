...
model EGF()
 ...
 // Variable initializations:
  ...
  kh = 0.0004; // 0.00024;
  kh has per_sec; 
  k2 = 6.346582508045875; // updated 3-20
  k2 has per_nMs;
  k_2 = 0.0003511551572382724; // updated 3-20
  k_2 has per_sec;
  k3 = 0.327410764680916; // 0.067; // This is the phosphorylation probability
  k3 has per_sec;
  k_3 = 0.30363880272987787; // Dephosphorylation probability
  k3 has per_sec;
  k4 = 0.05092157960120186; // Receptor-GS forward rate constant
  k4 has per_nMs;
  k_4 = 0.16240458001728209; // Receptor-GS reverse rate constant
  k_4 has per_sec;
  k5 = 0.00943832658908071; // Receptor - Shc recruitment
  k5 has per_nMs;
  k_5 = 6.987926808759547; // Dissociation of Shc from phospho-EGFR
  k_5 has per_sec;
  k6 = 536.3379084767382; // Phosphorylation of Shc
  k6 has per_sec;
  k7 = 192.64225260646887; // Receptor-pShc forward rate constant
  k7 has per_nMs;
  k_7 = 96.10432643764008; // Receptor-pShc reverse rate constant
  k_7 has per_sec;
  V8 = 9.74984501083786; // Dephosphorylation of Shc
  k8 has per_sec;
  V8 has nM_per_s;
  Km8 = 0.001521513845256277;
  Km8 has nM;
  k8 = 1.3;	
  k9 = 7.436937306541308e-05; // forward rate Grb2-Sos binding to pShc on receptor
  k9 has per_nMs;
  k_9 = 0.0014707590177329742; // dissociation of Grb2-Sos from pShc-receptor complex
  k_9 has per_sec;
  k10 = 0.00016903122919119582; // association pShc-GS to Rp
  k10 has per_nMs;
  k_10 = 4.599772707585778; // reverse binding of Grb2-Sos-pShc from receptor
  k_10 has per_sec;
  k11 = 0.010611952023274702; // association of pShc with GS
  k11 has per_nMs;
  k_11 = 3.7792659216483697; // dissociation of pShc-GS complex
  k_11 has per_sec;
  k13 = 0.00039260943807296536; // Association of RasGap with EGFR
  k13 has per_nMs;
  k_13 = 12.74152516082731; // Dissociation of RasGap
  k_13 has per_sec;
  krec = 778.8825843836573; // Recycling of the GS to pool
  krec has per_sec;
  k204 = 7.502955076622953e-07; //Grb2-SOS association rate constant
  k204 has per_nMs;
  k_204 = 1.7489476804499297e-13;
  k_204 has per_sec;	// Grb2-Sos dissociation rate constant
  k205 = 0.0008407411067444445; // Binding of SOS by Erk
  k205 has per_nMs;
  k_205 = 20.814302758184596; // Dissociation of SOS from ppErk
  k_205 has per_sec;
  kcat205 = 9943.943161700818; // phosphorylation of SOS
  kcat205 has per_sec;
  kcat_205 = 2.3593469904090005; // dephosphorylation of SOS
  kcat_205 has per_sec;
  k206 = 1.1268911130348252e-09; // Binding of 14-3-3 protein to Sos
  k206 has per_nMs;
  k_206 = 810.8214073107602; // Dissociation of 14-3-3 protein from Sos
  k_206 has per_sec;
  k60 = 0.6769041538449576; // Binding of Raf by Erk
  k60 has per_nMs;
  k_60 = 0.03075001159102666; // Dissociation of Raf from ERK
  k_60 has per_sec;
  kcat60 = 0.008206263315961753; // phosphorylation of Raf by Erk
  kcat60 has per_sec;
  kcat_60 = 2071.873786957733; // dephosphorylation of Raf
  kcat_60 has per_sec;
  k61 = 0.0010220335305271859; // Binding of 14-3-3 protein to Raf
  k61 has per_nMs;
  k_61 = 4.952805633103805e-06; // Dissociation of 14-3-3 protein from Raf
  k_61 has per_sec;
  kcat62 = 0.801793562291673; // Activation of Ras
  kcat62 has per_sec;
  Km62 = 10444.15537126135;
  Km62 has nM;
  kcat63 = 11948.697789022486; // ORIG 20000;
  kcat63 has per_sec;
  Km63 = 2.1499524070130187;
  Km63 has nM;
  kcat65 = 18504.83465404479;
  kcat65 has per_sec;
  Km65 = 206.31925509427987;
  Km65 has nM;
  kcat66 = 56.515232056003924; // activation of raf
  kcat66 has nM_per_s;
  Km66 = 1.2227396469868825; // raf activation equilibrium constant
  Km66 has nM;
  kcat67 = 24.101544410627657; // inactivation of Raf
  kcat67 has nM_per_s;
  Km67 = 3.3919932711512786; // Equilibrium inactivation of Raf
  Km67 has nM;
  kcat68 = 7.004963111801174;
  kcat68 has per_sec;
  Km68 = 0.3513587609382971;
  Km68 has nM;
  V69 = 4.31724060352199; // inactivation of Mek
  V69 has nM_per_s;
  Km69 = 22605.210710567677;
  Km69 has nM;
  kcat70 = 9.666783748076238;
  kcat70 has per_sec;
  Km70 = 0.8149016375817799;
  Km70 has nM;
  kcat71 = 0.13106725412929396;
  kcat71 has per_sec;
  Km71 = 4982.558205174397;
  Km71 has nM;
  V72 = 5.629401970690896;
  V72 has nM_per_s;
  Km72 = 1526.6380561507997;
  Km72 has nM;
  V73 = 0.39737769581080834;
  V73 has nM_per_s;
  Km73 = 724.5796787605233;
  Km73 has nM;
