...
model EGF()
 ...
 // Variable initializations:
  ...
  kh = 0.0004; // 0.00024;
  kh has per_sec; 
  k2 = 12.737996361873318; // updated 3-20
  k2 has per_nMs;
  k_2 = 0.7180917703351185; // updated 3-20
  k_2 has per_sec;
  k3 = 19.589078689784543; // 0.067; // This is the phosphorylation probability
  k3 has per_sec;
  k_3 = 59.63504879607423; // Dephosphorylation probability
  k3 has per_sec;
  k4 = 0.003037552908617645; // Receptor-GS forward rate constant
  k4 has per_nMs;
  k_4 = 0.18853476892013374; // Receptor-GS reverse rate constant
  k_4 has per_sec;
  k5 = 0.010719181688133855; // Receptor - Shc recruitment
  k5 has per_nMs;
  k_5 = 21.763397008049388; // Dissociation of Shc from phospho-EGFR
  k_5 has per_sec;
  k6 = 4.324590666431035; // Phosphorylation of Shc
  k6 has per_sec;
  k7 = 0.2158815023112329; // Receptor-pShc forward rate constant
  k7 has per_nMs;
  k_7 = 1.1186747638082568; // Receptor-pShc reverse rate constant
  k_7 has per_sec;
  V8 = 0.0027846704716688064; // Dephosphorylation of Shc
  k8 has per_sec;
  V8 has nM_per_s;
  Km8 = 0.0001605767392874321;
  Km8 has nM;
  k8 = 1.3;	
  k9 = 0.0039043628782933926; // forward rate Grb2-Sos binding to pShc on receptor
  k9 has per_nMs;
  k_9 = 0.0457845424597013; // dissociation of Grb2-Sos from pShc-receptor complex
  k_9 has per_sec;
  k10 = 2.315509557706363e-05; // association pShc-GS to Rp
  k10 has per_nMs;
  k_10 = 0.014825043972645637; // reverse binding of Grb2-Sos-pShc from receptor
  k_10 has per_sec;
  k11 = 56.708496723658286; // association of pShc with GS
  k11 has per_nMs;
  k_11 = 442.6109675229116; // dissociation of pShc-GS complex
  k_11 has per_sec;
  k13 = 0.0013876659739343062; // Association of RasGap with EGFR
  k13 has per_nMs;
  k_13 = 0.6046220553463557; // Dissociation of RasGap
  k_13 has per_sec;
  krec = 0.2689433154918347; // Recycling of the GS to pool
  krec has per_sec;
  k204 = 1.4203155235310134e-05; //Grb2-SOS association rate constant
  k204 has per_nMs;
  k_204 = 0.03411378175948785;
  k_204 has per_sec;	// Grb2-Sos dissociation rate constant
  k205 = 0.00011178673436833427; // Binding of SOS by Erk
  k205 has per_nMs;
  k_205 = 1.728345329443979; // Dissociation of SOS from ppErk
  k_205 has per_sec;
  kcat205 = 16.60777787870556; // phosphorylation of SOS
  kcat205 has per_sec;
  kcat_205 = 3.8089047400160965; // dephosphorylation of SOS
  kcat_205 has per_sec;
  k206 = 0.08636491707722031; // Binding of 14-3-3 protein to Sos
  k206 has per_nMs;
  k_206 = 0.05731945645441363; // Dissociation of 14-3-3 protein from Sos
  k_206 has per_sec;
  k60 = 0.2503080260326254; // Binding of Raf by Erk
  k60 has per_nMs;
  k_60 = 0.044313428110889855; // Dissociation of Raf from ERK
  k_60 has per_sec;
  kcat60 = 0.00012351644487332768; // phosphorylation of Raf by Erk
  kcat60 has per_sec;
  kcat_60 = 0.1930303743623101; // dephosphorylation of Raf
  kcat_60 has per_sec;
  k61 = 0.20441681859360455; // Binding of 14-3-3 protein to Raf
  k61 has per_nMs;
  k_61 = 0.15052438498757598; // Dissociation of 14-3-3 protein from Raf
  k_61 has per_sec;
  kcat62 = 19.12427363425897; // Activation of Ras
  kcat62 has per_sec;
  Km62 = 6122.42186852303;
  Km62 has nM;
  kcat63 = 213.44057335715485; // ORIG 20000;
  kcat63 has per_sec;
  Km63 = 5.158521648584163;
  Km63 has nM;
  kcat65 = 74.05132142248893;
  kcat65 has per_sec;
  Km65 = 9.673693223564566;
  Km65 has nM;
  kcat66 = 82.2663959260669; // activation of raf
  kcat66 has nM_per_s;
  Km66 = 3.006966775658553; // raf activation equilibrium constant
  Km66 has nM;
  kcat67 = 499.94077385986685; // inactivation of Raf
  kcat67 has nM_per_s;
  Km67 = 36.71517981925311; // Equilibrium inactivation of Raf
  Km67 has nM;
  kcat68 = 395.0656742605329;
  kcat68 has per_sec;
  Km68 = 0.35475744331162085;
  Km68 has nM;
  V69 = 0.1145173450848951; // inactivation of Mek
  V69 has nM_per_s;
  Km69 = 0.01741283254711098;
  Km69 has nM;
  kcat70 = 0.11270074803118915;
  kcat70 has per_sec;
  Km70 = 12.712172503752418;
  Km70 has nM;
  kcat71 = 0.4882144495058735;
  kcat71 has per_sec;
  Km71 = 29.58334543123156;
  Km71 has nM;
  V72 = 26.448347479286397;
  V72 has nM_per_s;
  Km72 = 135682.9961629682;
  Km72 has nM;
  V73 = 45.30949144669996;
  V73 has nM_per_s;
  Km73 = 1.5666036463733524;
  Km73 has nM;
