...
model EGF()
 ...
 // Variable initializations:
  ...
  kh = 0.0004; // 0.00024;
  kh has per_sec; 
  k2 = 72.87383441434112; // updated 3-20
  k2 has per_nMs;
  k_2 = 0.017;	// updated 3-20
  k_2 has per_sec;
  k3 = 0.382124806435552; // 0.067; // This is the phosphorylation probability
  k3 has per_sec;
  k_3 = 1.3;				// Dephosphorylation probability
  k3 has per_sec;
  k4 = 3.728392336989141e-06; // Receptor-GS forward rate constant
  k4 has per_nMs;
  k_4 = .5;			// Receptor-GS reverse rate constant
  k_4 has per_sec;
  k5 = 0.47413114932906125; // Receptor - Shc recruitment
  k5 has per_nMs;
  k_5 = 2;		// Dissociation of Shc from phospho-EGFR
  k_5 has per_sec;
  k6 = 4.5887406867708385e-05; // Phosphorylation of Shc
  k6 has per_sec;
  k7 = 2.3239552761293344e-06; // Receptor-pShc forward rate constant
  k7 has per_nMs;
