...
model EGF()
 ...
 // Variable initializations:
  k1 = 0.000978964106119787;
  k1 has per_nMs;
  k_1 = 0.039998464127058535;
  k_1 has per_sec;
  kt = 0.0012;
  kt has per_sec;
  ke = .0033;
  ...
  kh = 0.0004; // 0.00024;
  kh has per_sec; 
  k2 = 1.7299105963336754; // updated 3-20
  k2 has per_nMs;
  k_2 = 0.00017000000000016034; // updated 3-20
  k_2 has per_sec;
  k3 = 37.10286509784551; // 0.067; // This is the phosphorylation probability
  k3 has per_sec;
  k_3 = 10.266417706263475; // Dephosphorylation probability
  k3 has per_sec;
  k4 = 22.231277737613496; // Receptor-GS forward rate constant
  k4 has per_nMs;
  k_4 = 0.06790470810893368; // Receptor-GS reverse rate constant
  k_4 has per_sec;
  k5 = 0.2789376777920881; // Receptor - Shc recruitment
  k5 has per_nMs;
  k_5 = 0.020154875239230225; // Dissociation of Shc from phospho-EGFR
  k_5 has per_sec;
  k6 = 2.231801084552376; // Phosphorylation of Shc
  k6 has per_sec;
  k7 = 14.399999999988106; // Receptor-pShc forward rate constant
  k7 has per_nMs;
  k_7 = 0.04543471846039423; // Receptor-pShc reverse rate constant
  k_7 has per_sec;
  V8 = 202.5013872549377; // Dephosphorylation of Shc
  k8 has per_sec;
  V8 has nM_per_s;
  Km8 = 8236.90563743074;
  Km8 has nM;
  k8 = 1.3;	
  k9 = 0.6269808429891571; // forward rate Grb2-Sos binding to pShc on receptor
  k9 has per_nMs;
  k_9 = 81.91365449610613; // dissociation of Grb2-Sos from pShc-receptor complex
  k_9 has per_sec;
  k10 = 5.470000000175253e-06; // association pShc-GS to Rp
  k10 has per_nMs;
  k_10 = 199.7973385183668; // reverse binding of Grb2-Sos-pShc from receptor
  k_10 has per_sec;
  k11 = 20.198423246914366; // association of pShc with GS
  k11 has per_nMs;
  k_11 = 0.2192441919516365; // dissociation of pShc-GS complex
  k_11 has per_sec;
  k13 = 8.270823921522447e-05; // Association of RasGap with EGFR
  k13 has per_nMs;
  k_13 = 0.24911394557035063; // Dissociation of RasGap
  k_13 has per_sec;
  krec = 0.08171261515683957; // Recycling of the GS to pool
  krec has per_sec;
  k204 = 9.450000013497468e-08; //Grb2-SOS association rate constant
  k204 has per_nMs;
  k_204 = 0.0057424146359172715;
  k_204 has per_sec;	// Grb2-Sos dissociation rate constant
  k205 = 0.02499992130975994; // Binding of SOS by Erk
  k205 has per_nMs;
  k_205 = 2.499999853828786; // Dissociation of SOS from ppErk
  k_205 has per_sec;
  kcat205 = 99.97107743446264; // phosphorylation of SOS
  kcat205 has per_sec;
  kcat_205 = 9.999999973420893; // dephosphorylation of SOS
  kcat_205 has per_sec;
  k206 = 0.09998806011914119; // Binding of 14-3-3 protein to Sos
  k206 has per_nMs;
  k_206 = 1.0014990187014859e-05; // Dissociation of 14-3-3 protein from Sos
  k_206 has per_sec;
  k60 = 0.006515978675969806; // Binding of Raf by Erk
  k60 has per_nMs;
  k_60 = 0.00025006659912885727; // Dissociation of Raf from ERK
  k_60 has per_sec;
  kcat60 = 49.999999970966435; // phosphorylation of Raf by Erk
  kcat60 has per_sec;
  kcat_60 = 93.01846477346885; // dephosphorylation of Raf
  kcat_60 has per_sec;
  k61 = 0.0962776417602439; // Binding of 14-3-3 protein to Raf
  k61 has per_nMs;
  k_61 = 2.282346484411544e-05; // Dissociation of 14-3-3 protein from Raf
  k_61 has per_sec;
  kcat62 = 2.378709223158324; // Activation of Ras
  kcat62 has per_sec;
  Km62 = 50.50350911413339;
  Km62 has nM;
  kcat63 = 13028.411240971524; // ORIG 20000;
  kcat63 has per_sec;
  Km63 = 4977.00359574381;
  Km63 has nM;
  kcat65 = 0.024934144722601942;
  kcat65 has per_sec;
  Km65 = 7770.387042334581;
  Km65 has nM;
  kcat66 = 17.118196490641136; // activation of raf
  kcat66 has nM_per_s;
  Km66 = 999.9999998829811; // raf activation equilibrium constant
  Km66 has nM;
  kcat67 = 29.495277030645557; // inactivation of Raf
  kcat67 has nM_per_s;
  Km67 = 1446.6331498423515; // Equilibrium inactivation of Raf
  Km67 has nM;
  kcat68 = 2.5465319228202548;
  kcat68 has per_sec;
  Km68 = 0.500000003376656;
  Km68 has nM;
  V69 = 1.402173221295755; // inactivation of Mek
  V69 has nM_per_s;
  Km69 = 20117.150146605887;
  Km69 has nM;
  kcat70 = 0.8804807891093328;
  kcat70 has per_sec;
  Km70 = 6672.824059117307;
  Km70 has nM;
  kcat71 = 0.13882323691351725;
  kcat71 has per_sec;
  Km71 = 14.683351570259171;
  Km71 has nM;
  V72 = 16.838595562361522;
  V72 has nM_per_s;
  Km72 = 475.5182649519353;
  Km72 has nM;
  V73 = 6.880382809752779;
  V73 has nM_per_s;
  Km73 = 5.000000005890726;
  Km73 has nM;
