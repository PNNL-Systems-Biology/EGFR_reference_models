...
model EGF()
 ...
 // Variable initializations:
  ...
  kh = 0.0004; // 0.00024;
  kh has per_sec; 
  k2 = 576.6487300120573; // updated 3-20
  k2 has per_nMs;
  k_2 = 0.00025573849477696423; // updated 3-20
  k_2 has per_sec;
  k3 = 22.14551939398801; // 0.067; // This is the phosphorylation probability
  k3 has per_sec;
  k_3 = 18.218732896786722; // Dephosphorylation probability
  k3 has per_sec;
  k4 = 0.0009489444062016731; // Receptor-GS forward rate constant
  k4 has per_nMs;
  k_4 = 1.8959275411231364; // Receptor-GS reverse rate constant
  k_4 has per_sec;
  k5 = 0.0014399722493961395; // Receptor - Shc recruitment
  k5 has per_nMs;
  k_5 = 2.42355209276542; // Dissociation of Shc from phospho-EGFR
  k_5 has per_sec;
  k6 = 2973.490551147128; // Phosphorylation of Shc
  k6 has per_sec;
  k7 = 96.695887974578; // Receptor-pShc forward rate constant
  k7 has per_nMs;
  k_7 = 41.91618196228269; // Receptor-pShc reverse rate constant
  k_7 has per_sec;
  V8 = 1.2235386603750373; // Dephosphorylation of Shc
  k8 has per_sec;
  V8 has nM_per_s;
  Km8 = 3.6826417464892803e-06;
  Km8 has nM;
  k8 = 1.3;	
  k9 = 3.798048683507542e-05; // forward rate Grb2-Sos binding to pShc on receptor
  k9 has per_nMs;
  k_9 = 0.9541723725113787; // dissociation of Grb2-Sos from pShc-receptor complex
  k_9 has per_sec;
  k10 = 7.556325168734489e-06; // association pShc-GS to Rp
  k10 has per_nMs;
  k_10 = 0.4631035418935612; // reverse binding of Grb2-Sos-pShc from receptor
  k_10 has per_sec;
  k11 = 64.63481449102422; // association of pShc with GS
  k11 has per_nMs;
  k_11 = 0.02101217661491527; // dissociation of pShc-GS complex
  k_11 has per_sec;
  k13 = 0.0003878505045907204; // Association of RasGap with EGFR
  k13 has per_nMs;
  k_13 = 0.0005831359278465444; // Dissociation of RasGap
  k_13 has per_sec;
  krec = 17.39407469302174; // Recycling of the GS to pool
  krec has per_sec;
  k204 = 0.0013116089753177713; //Grb2-SOS association rate constant
  k204 has per_nMs;
  k_204 = 4.4192857998913985e-09;
  k_204 has per_sec;	// Grb2-Sos dissociation rate constant
  k205 = 0.0012027168409298329; // Binding of SOS by Erk
  k205 has per_nMs;
  k_205 = 2.320756240701734; // Dissociation of SOS from ppErk
  k_205 has per_sec;
  kcat205 = 0.24376413558976898; // phosphorylation of SOS
  kcat205 has per_sec;
  kcat_205 = 0.2285119557997253; // dephosphorylation of SOS
  kcat_205 has per_sec;
  k206 = 2.873565299705711e-10; // Binding of 14-3-3 protein to Sos
  k206 has per_nMs;
  k_206 = 2.5995950672512094; // Dissociation of 14-3-3 protein from Sos
  k_206 has per_sec;
  k60 = 0.06170674602167359; // Binding of Raf by Erk
  k60 has per_nMs;
  k_60 = 9.759031084013863; // Dissociation of Raf from ERK
  k_60 has per_sec;
  kcat60 = 0.003352969308728545; // phosphorylation of Raf by Erk
  kcat60 has per_sec;
  kcat_60 = 0.7753781562181188; // dephosphorylation of Raf
  kcat_60 has per_sec;
  k61 = 0.2088922231908095; // Binding of 14-3-3 protein to Raf
  k61 has per_nMs;
  k_61 = 0.017174170288358; // Dissociation of 14-3-3 protein from Raf
  k_61 has per_sec;
  kcat62 = 1.3987757831589618; // Activation of Ras
  kcat62 has per_sec;
  Km62 = 93.01723307097906;
  Km62 has nM;
  kcat63 = 3.7454674034255846; // ORIG 20000;
  kcat63 has per_sec;
  Km63 = 0.07790148702543873;
  Km63 has nM;
  kcat65 = 87.47776166220115;
  kcat65 has per_sec;
  Km65 = 0.05236120987637648;
  Km65 has nM;
  kcat66 = 173.32965033095698; // activation of raf
  kcat66 has nM_per_s;
  Km66 = 1.1177796386641106; // raf activation equilibrium constant
  Km66 has nM;
  kcat67 = 208.63839383274725; // inactivation of Raf
  kcat67 has nM_per_s;
  Km67 = 222.67248061327325; // Equilibrium inactivation of Raf
  Km67 has nM;
  kcat68 = 742.7664541320058;
  kcat68 has per_sec;
  Km68 = 0.002027367451016168;
  Km68 has nM;
  V69 = 265.3138968547354; // inactivation of Mek
  V69 has nM_per_s;
  Km69 = 127.74806743113682;
  Km69 has nM;
  kcat70 = 0.9834617122098249;
  kcat70 has per_sec;
  Km70 = 24.056211622154578;
  Km70 has nM;
  kcat71 = 0.5769840316434255;
  kcat71 has per_sec;
  Km71 = 300.7548835689114;
  Km71 has nM;
  V72 = 0.8259855043344454;
  V72 has nM_per_s;
  Km72 = 9277.76395178403;
  Km72 has nM;
  V73 = 0.6955433036970927;
  V73 has nM_per_s;
  Km73 = 1.0075097279993237;
  Km73 has nM;
