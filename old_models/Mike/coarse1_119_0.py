...
Precursor: -> Lp; kLp*C1 - dLp_3*Lp;
Spry: -> Spry2; Ha(Va, Ka, na, Ka2, na2, t, Lc);
Mig: -> Mig6; Hi(Vi, Ki, ni, Ki2, ni2, t, Lc);
...
model.exportToSBML('output/coarse1_xml/coarse1_119_0.xml')
