...
r = te.loada('EGFR_Reference_Model_test.ant')

sim = r.simulate(0, 8, 33, ['time', 'EGFR_pEgfr_Tgfa', 'GAREM_aRtot_Grb2_Garem', 'GAREM_Grb2_ppGarem_pShp2'])
...
#
# plt.plot(t, sim['EGFR_aRtot'], label='active EGFR fit')
# plt.scatter(egfr_time, egfr, label='active EGFR data')
#
# plt.plot(t, sim['GAREM_Grb2_ppGarem_pShp2'], label='garem-complex fit')
# plt.scatter(garem_time, garem, label='garem-complex data')
#
# plt.plot(t, sim['SHC_pShc1'], label='shc-complex fit')
# plt.scatter(shc_time, shc, label='shc-complex data')
#
# plt.plot(t, sim['GAB_Grb2_ppGab1_pShp2'], label='gab-complex fit')
# plt.scatter(gab_time, gab, label='gab-complex data')
#
# plt.plot(t, sim['SOS_tRas'], label='tRas fit')
