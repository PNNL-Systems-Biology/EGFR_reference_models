...
# ax[0].plot(t, sim['pSOS1'], label='pSOS1 fit')
# ax[0].scatter(l2_time, sos, label='pSOS1 data')
#
# ax[1].plot(t, sim['aRas'], label='aRas fit')
# ax[1].scatter(l2_time, ras, label='aRas data')

ax.plot(t, sim['aRas'], label='aRas fit')
ax.scatter(l2_time, ras, label='aRas data')
