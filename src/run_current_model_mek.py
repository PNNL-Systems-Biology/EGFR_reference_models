...
sim = r.simulate(0, 12, 1201, selections=['time', 'RAS', 'ppERK', 'ppMEK', 'RASb_pRAF_d1433u'])
print(11, sim['RASb_pRAF_d1433u'])
...
plt.plot(t, sim['ppMEK'], c='red', label='MEK fit')
plt.plot(t, sim['RASb_pRAF_d1433u'], c='green', label='RAFa trace')
