...
sim = r.simulate(0, 12, 1201, selections=['time', 'RAS', 'RASb_pRAF_d1433u_MEK', 'RAFa_ppMEK', 'ppERK'])
# sim = r.simulate(0, 10, 1201, selections=['time', 'RAS', 'RASb_pRAF_d1433u', 'RAFa_ppMEK', 'ppERK'])
# sim = r.simulate(0, 12, 1201, selections=['time', 'ppERK'])
...
# plt.plot(t, sim['RASb_pRAF_d1433u'], label='RAF fit')
