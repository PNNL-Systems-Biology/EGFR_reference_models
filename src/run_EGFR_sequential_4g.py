...
# r = te.loada('EGFR_sequential_fit_4b.ant')
r = te.loada('EGFR_sequential_fit_4g.ant')
...
response2 = [0.67, 0.95, 3.17, 5.76, 10.61, 16.05, 19.87, 19.18]
...
#     r.reset()
#     r.Lig = dose1[i]
#     sim = r.simulate(0, 720, 7201, selections=['time', 'pSOS1', 'aRas'])
# #     fit240.append(sim[2400][1])
#     print(sim['time'][2400])0
...
# ax[0].set_xscale('log')
# ax[0].scatter(dose1, response1, label='SOS data')
# ax[0].scatter(dose1, fit_response1, label='SOS fit')
# ax[0].title.set_text('SOS')
#
# ax[1].set_xscale('log')
# ax[1].scatter(dose2, response2, label='Ras data')
# ax[1].scatter(dose2, fit_response2, label='Ras fit')
# ax[1].title.set_text('Ras')
